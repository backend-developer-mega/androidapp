...
public class kidsSubAct extends AppCompatActivity {
    ...
    private void initDefine() {
        ...
        this.txtTitleSubHome.setText(category);
    ...
    private void setRvAdapter() {
        ...
        kidsSubHomeAdapter subHomeAdapter2 = new kidsSubHomeAdapter(this.context, this.learningDataModelArrayList, this.position, this.TYPE);
